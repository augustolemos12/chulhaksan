...
export class CreateEventDto {
  @ApiProperty({
    ...
    description: 'Título del evento del mes (2–200 caracteres, se elimina el espacio en blanco inicial y final)',
  })
  @IsString()
  @IsNotEmpty({ message: 'El título no puede estar vacío ni contener sólo espacios en blanco.' })
   ...
   */
  @ApiPropertyOptional({
    example: 'https://res.cloudinary.com/demo/image/upload/v1234567/chulhaksan_events/sample.jpg',
    description: 'URL de la imagen en Cloudinary (asignada por el backend, no enviar desde el cliente)',
  })
  @IsOptional()
  @IsString()
  @IsUrl()
