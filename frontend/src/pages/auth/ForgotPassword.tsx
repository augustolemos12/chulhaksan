          ...
          <div className="flex flex-col gap-4">
            <label className="flex flex-col w-full">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  className="form-input flex w-full rounded-xl text-[#1a1a2e] border-border bg-surface focus:ring-2 focus:ring-primary/20 focus:border-primary h-[58px] placeholder:text-slate-300 pl-12 pr-4 text-base font-normal transition-all shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)]"
                  inputMode="numeric"
