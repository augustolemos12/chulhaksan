...
export function useAdminClassGroups() {
  ...
  useEffect(() => { loadClassGroups(); }, [page, gymFilter, teacherFilter, categoryFilter]);
  useEffect(() => { setPage(1); }, [gymFilter, teacherFilter, categoryFilter]);
  ...
  }, [gymFilter, teacherFilter, categoryFilter, page]);
  ...
  return {
    classGroups, total, loading, error, gymFilter, setGymFilter, teacherFilter, setTeacherFilter, categoryFilter, setCategoryFilter,
    page, setPage, pageSize, gyms, teachers, searchParams, setSearchParams,
