...
import type { ClassGroupItem, ClassGroupForm, DayOfWeek } from '../hooks/useTeacherClassGroups';
import { emptyForm } from '../hooks/useTeacherClassGroups';
...
export function CreateClassGroupModal({
  ...
  gyms, handleCreate, creating, createError
}: CreateModalProps) {
...
export function EditClassGroupModal({
  ...
  gyms, handleSave, saving, editError
}: EditModalProps) {
